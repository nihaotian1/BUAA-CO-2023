...
`define RS_MD      3'b011
`define RS_CPOUT   3'b100

`define NPC_pc4   3'b000
`define NPC_Imm16 3'b001
`define NPC_Imm26 3'b010
`define NPC_ra    3'b011
`define NPC_EPC   3'b100
...
`define DATAMEM_LO  32'h0000_0000
`define DATAMEM_HI  32'h0000_2fff

`define INSMEM_LO   32'h0000_3000
`define INSMEM_HI   32'h0000_6fff

`define TIMER_LO_0  32'h0000_7f00
`define TIMER_HI_0  32'h0000_7f0b

`define TIMER_LO_1  32'h0000_7f10
`define TIMER_HI_1  32'h0000_7f1b

`define INTER_LO    32'h0000_7f20
`define INTER_HI    32'h0000_7f23

`define EXC_ADEL     5'd4
`define EXC_ADES     5'd5
`define EXC_SYSCALL  5'd8
`define EXC_RI       5'd10
`define EXC_OVERFLOW 5'd12
